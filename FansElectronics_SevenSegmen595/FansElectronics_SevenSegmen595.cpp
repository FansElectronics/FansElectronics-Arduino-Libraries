...
// SevSeg595
//-------------------------------------------------------------------------tr---------------------------------------------
SevenSegmen595::SevenSegmen595(byte pinData, byte pinClock, byte pinLatch, byte pinDig1, byte pinDig2, byte pinDig3, byte pinDig4, bool divice)
{
  if(divice){
...
// Void setNumber
//----------------------------------------------------------------------------------------------------------------------
void SevenSegmen595::setNumber(int numToShow)
{
...
// Void displayDigit
//----------------------------------------------------------------------------------------------------------------------
void SevenSegmen595::displayDigit(byte numDisplay, byte digitToDisplay){
